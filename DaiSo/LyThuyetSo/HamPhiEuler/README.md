...
3. **Nếu $a$ và $b$ nguyên tố cùng nhau**, thì:
   ...
   Tính chất này không dễ nhận thấy. Nó xuất phát từ [Định lý thặng dư Trung Hoa](../SoHocModule/DinhLySoDuTrungQuoc/README.md). Định lý thặng dư Trung Hoa đảm bảo rằng với mỗi $0 \leq x < a$ và mỗi $0 \leq y < b$, tồn tại duy nhất $0 \leq z < ab$ với $z \equiv x \pmod{a}$ và $z \equiv y \pmod{b}$. Không khó để chứng minh rằng $z$ nguyên tố cùng nhau với $ab$ khi và chỉ khi $x$ nguyên tố cùng nhau với $a$ và $y$ nguyên tố cùng nhau với $b$.
